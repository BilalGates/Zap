...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar clientes</title>
    </head>
    <body>
        ...
        <div class="form">
            ...
            <form method="POST" action="../php/zap_eliminar_cliente.php">
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            echo "DELETE FROM clients WHERE ID_client = '" . $_POST["Tid"] . "'";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia2 = "DELETE FROM clients WHERE ID_client = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos del cliente se han eliminado correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
