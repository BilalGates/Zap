...
<html lang="es">
    <head>
        ...
        <title>ZAP · Insertar estaciones</title>
    </head>
    <body>
        ...
        <div class="form">
        <h2>Insertar estaciones</h2>
            <form method="POST" action="../php/zap_insertar_estaciones.php">
            ...
            <?php 
                if (isset($_POST["Insertar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tnombre"]) or empty($_POST["Tciudad"]) or empty($_POST["Tnumvias"])) {
                        ...
                        if ($fila[0] == 1) {
                            echo "<br> La estación ya existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "INSERT INTO estacions VALUES ( '" . $_POST["Tid"] . "', '" . $_POST["Tnombre"] . "', '" . $_POST["Tciudad"] . "', '" . $_POST["Tnumvias"] . "')" ;
