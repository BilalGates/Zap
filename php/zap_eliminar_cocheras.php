...
<html lang="es">
    <head>
        ...
        <title>ZAP ·  Eliminar cocheras</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Eliminar cocheras:</h2>
            <form method="POST" action="../php/zap_eliminar_cocheras.php">
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia = "UPDATE personal SET id_cotxeres = NULL WHERE id_cotxeres = '" . $_POST["Tid"] . "'";
                            $sentencia1 = "UPDATE viatges SET id_cotxeres = NULL WHERE id_cotxeres = '" . $_POST["Tid"] . "'";
                            $sentencia2 = "DELETE FROM cotxeres WHERE id_cotxeres = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos de la cochera se han eliminado correctamente correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
