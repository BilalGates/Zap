...
<html lang="es">
    <head>
        ...
        <title>ZAP · Consultar viajes</title>
    </head>
    <body>
        ...
        <div class="table">
            ...
            <form method="POST" action="../php/zap_consultar_viajes.php">
            <form method="POST" action="../php/zap_consultar_cliente.php">
            </form>
            <div class="cancelar">
