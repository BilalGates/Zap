...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar estaciones</title>
    </head>
    <body>
        ...
        <div class="form">
            ...
            <form method="POST" action="../php/zap_eliminar_estaciones.php">
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia = "UPDATE personal SET id_estacio = NULL WHERE id_estacio = '" . $_POST["Tid"] . "'";
                            $sentencia1 = "UPDATE viatges SET id_estacio = NULL WHERE id_estacio = '" . $_POST["Tid"] . "'";
                            $sentencia2 = "DELETE FROM estacions WHERE id_estacio = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos de la estación se han eliminado correctamente correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
