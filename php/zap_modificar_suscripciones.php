...
<html lang="es">
    <head>
        ...
        <title>ZAP · Modificar suscripciones</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Modificar suscripciones</h2>
            <form method="POST" action="../php/zap_modificar_suscripciones.php">
            ...
            <?php 
                if (isset($_POST["Modificar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tplan"]) or empty($_POST["Tprecio"]) or empty($_POST["Tcuenta"])) {
                        ...
                        if ($fila[0] == 0) {
                            echo "<br> La suscripción no existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "UPDATE subscripcio SET Pla = '" . $_POST["Tplan"] . "', Preu = '" . $_POST["Tprecio"] . "', Compte = '" . $_POST["Tcuenta"] . "'" . " WHERE ID_sub = '" . $_POST["Tid"] . "'";
