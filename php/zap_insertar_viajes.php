...
<html lang="es">
    <head>
        ...
        <title>ZAP · Insertar viajes</title>
    </head>
    <body>
        ...
        <div class="form">   
            <h2>Insertar viajes</h2>
            <form method="POST" action="../php/zap_insertar_viajes.php">
                <label>ID del viaje:
            ...
            <?php 
                if (isset($_POST["Insertar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Ttren"]) or empty($_POST["Torigen"]) or empty($_POST["Tdestino"]) or empty($_POST["Tdia"]) or empty($_POST["Thora"]) or empty($_POST["Tidestacion"]) or empty($_POST["Tidcochera"])) {
                        ...
                        if ($fila[0] == 1) {
                            echo "<br> El viaje ya existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "INSERT INTO viatges VALUES (ID_viatge = '" . $_POST["Tid"] . "',Tren = '" . $_POST["Ttren"] . "', Origen = '" . $_POST["Torigen"] . "', Desti = '" . $_POST["Tdestino"] . "', Dia_hora = '" . $_POST["Tdia"] . $_POST["Thora"] . "', ID_estacio = '" . $_POST["Tidestacion"] . "', ID_cotxeres = '" . $_POST["Tidcochera"]  . "')";
