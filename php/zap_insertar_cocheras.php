...
<html lang="es">
    <head>
        ...
        <title>ZAP · Insertar cocheras</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Insertar cocheras</h2>
            <form method="POST" action="../php/zap_insertar_cocheras.php">
            ...
            <?php 
                if (isset($_POST["Insertar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tnombre"]) or empty($_POST["Tprovincia"]) or empty($_POST["Tcapacidad"])) {
                        ...
                        if ($fila[0] == 1) {
                            echo "<br> La cochera ya existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "INSERT INTO cotxeres VALUES ( '" . $_POST["Tid"] . "', '" . $_POST["Tnombre"] . "', '" . $_POST["Tprovincia"] . "', '" . $_POST["Tcapacidad"] . "')" ;
