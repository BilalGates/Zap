...
<html lang="es">
    <head>
        ...
        <title>ZAP · Modificar cocheras</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Modificar cocheras</h2>
            <form method="POST" action="../php/zap_modificar_cocheras.php">
                <label>ID de la cochera:
                <input type="text" name="Tid" size=50></label> <br>
                <label>Nombre:
                <input type="text" name="Tnombre"></label> <br>   
                <label>Provincia:
                <input type="text" name="Tprovincia" size=50></label> <br>
                <label>Capacidad:
                <input type="text" name="Tcapacidad" size=50></label> <br>
            ...
            <?php 
                if (isset($_POST["Modificar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tnombre"]) or empty($_POST["Tprovincia"]) or empty($_POST["Tcapacidad"])) {
                        ...
                        $sentenciaS = "SELECT count(*) FROM cotxeres WHERE ID_cotxeres = '" . $_POST["Tid"] . "'";
                        ...
                        if ($fila[0] == 0) {
                            echo "<br> La cochera no existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "UPDATE cotxeres SET Nom = '" . $_POST["Tnombre"] . "', Provincia = '" . $_POST["Tprovincia"] . "', Capacitat = '" . $_POST["Tcapacidad"] . "'" . " WHERE ID_cotxeres = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result) {
                            ...
                            echo "<div class='message success'>Los datos de la cochera se han modificado correctamente.</div>";
                        }
