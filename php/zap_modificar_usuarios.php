...
<html lang="es">
    <head>
        ...
        <title>ZAP · Insertar usuarios</title>
    </head>
    <body>
        ...
        <h2>Modificar usuarios</h2>
            <form method="POST" action="../php/zap_modificar_usuarios.php">
                <label>Nombre de usuario:
                <input type="text" name="Tid"></label> <br>
                <label>Tipo:
                <select name="Ttipo">
                ...
                <label>Contraseña:
                <input type="password" name="Tcontrasenya1"></label> <br>
                <label>Repite la contraseña:
                <input type="password" name="Tcontrasenya2"></label> <br>
            ...
            <?php 
                if (isset($_POST["Modificar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tcontrasenya1"]) or empty($_POST["Tcontrasenya2"])) {
                        ...
                        if ($_POST["Tcontrasenya1"] != $_POST["Tcontrasenya2"]) {
                            ...
                            if ($fila[0] == 0) {
                                ...
                                $sentencia = "UPDATE usuaris SET tipus = '" . $_POST["Ttipo"] . "', contrasenya = '" . $_POST["Tcontrasenya1"] . "' WHERE usuari = '" . $_POST["Tid"] . "'";
                                
                                $result=mysqli_query($enlace, $sentencia);
                            if (!$result) {
                                echo "<div class='message error'>El registro no se ha podido modificar </div>";
                            } else {
                                echo "<div class='message success'>Usuario modificado correctamente.</div>";
                            }
                        }
