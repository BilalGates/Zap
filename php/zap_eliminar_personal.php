...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar personal</title>
    </head>
    <body>
        ...
        <div class="form">
            ...
            <form method="POST" action="../php/zap_eliminar_personal.php">
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia2 = "DELETE FROM personal WHERE id_personal = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos del personal se han eliminado correctamente correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
