...
<html lang="es">
    ...
    <body>
        ...
        <h2>Insertar usuarios</h2>
            <form method="POST" action="../php/zap_insertar_usuarios.php">
            ...
            <?php 
                if (isset($_POST["Insertar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Ttipo"]) or empty($_POST["Tcontrasenya1"]) or empty($_POST["Tcontrasenya2"])) {
                        ...
                        if ($_POST["Tcontrasenya1"] != $_POST["Tcontrasenya2"]) {
                            ...
                            if ($fila[0] == 1) {
                                ...
                                $sentencia = "INSERT INTO usuaris VALUES ( '" . $_POST["Tid"] . "', '" . $_POST["Ttipo"] . "', '" . $_POST["Tcontrasenya1"] . "')" ;
                                
                                $result=mysqli_query($enlace, $sentencia);
                            if (!$result) {
                                echo "<div class='message error'>El registro no se ha podido modificar </div>";
                            } else {
                                echo "<div class='message success'>Usuario creado correctamente.</div>";
                            }
                        }
