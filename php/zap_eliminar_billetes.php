...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar billetes</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Eliminar billetes</h2>
            <form method="POST" action="../php/zap_eliminar_billetes.php">
            ...
            <?php
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        $sentenciaS = "SELECT count(*) FROM bitllets WHERE ID_billet = '" . $_POST["Tid"] . "'";
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia = "UPDATE clients SET id_billet = null WHERE ID_billet = '" . $_POST["Tid"] . "'";
                            $sentencia2 = "DELETE FROM bitllets WHERE ID_billet = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Billete eliminado correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
