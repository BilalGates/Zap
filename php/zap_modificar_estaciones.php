...
<html lang="es">
    <head>
        ...
        <title>ZAP · Modificar estaciones</title>
    </head>
    <body>
        ...
        <div class="form">
            ...
            <form method="POST" action="../php/zap_modificar_estaciones.php">
                <label>ID de la estación:
                <input type="text" name="Tid" size=50></label> <br>
                <label>Nombre:
                <input type="text" name="Tnombre"></label> <br>   
                <label>Ciudad:
                <input type="text" name="Tciudad" size=50></label> <br>
                <label>Número de vías:
                <input type="text" name="Tnumvias" size=50></label> <br>
            ...
            <?php 
                if (isset($_POST["Modificar"])) {
                    if (empty($_POST["Tid"]) or empty($_POST["Tnombre"]) or empty($_POST["Tciudad"]) or empty($_POST["Tnumvias"])) {
                        ...
                        $sentenciaS = "SELECT count(*) FROM estacions WHERE ID_estacio = '" . $_POST["Tid"] . "'";
                        ...
                        if ($fila[0] == 0) {
                            echo "<br> La estación no existe.";
                        } else {
                            //se crea la sentencia del registro a eliminar
                            $sentencia = "UPDATE estacions SET Nom = '" . $_POST["Tnombre"] . "', Ciutat = '" . $_POST["Tciudad"] . "', Numero_vies = '" . $_POST["Tnumvias"] . "'" . " WHERE ID_estacio = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result) {
                            ...
                            echo "<div class='message success'>Los datos de la estación se han modificado correctamente.</div>";
                        }
