...
<html lang="es">
    <head>
        ...
        <title>ZAP · Consultar estaciones</title>
    </head>
    <body>
        ...
        <div class="table">
            <h2>Consultar estaciones</h2>
            <form method="POST" action="../php/zap_consultar_estaciones.php">
            </form>
            <div class="cancelar">
            ...
            <?php
                ...
                $sentencia= "SELECT * FROM estacions";
