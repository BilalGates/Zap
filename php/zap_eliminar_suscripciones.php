...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar suscripción</title>
    </head>
    <body>
        ...
        <div class="form">
            ...
            <form method="POST" action="../php/zap_eliminar_suscripciones.php">
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia1 = "UPDATE clients SET id_sub = NULL WHERE id_sub = '" . $_POST["Tid"] . "'";
                            $sentencia2 = "DELETE FROM subscripcio WHERE ID_sub = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos de la suscripción se han eliminado correctamente correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
