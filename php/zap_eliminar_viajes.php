...
<html lang="es">
    <head>
        ...
        <title>ZAP · Eliminar viajes</title>
    </head>
    <body>
        ...
        <div class="form">
            <h2>Eliminar viajess</h2>
            <form method="POST" action="../php/zap_eliminar_viajes.php">
                <label>ID del viaje:
                ...
                if (isset($_POST["Eliminar"])) {
                    if (empty($_POST["Tid"])) {
                        ...
                        if ($fila[0] == 0) {
                            ...
                            $sentencia = "UPDATE personal SET id_viatge = NULL WHERE id_viatge = '" . $_POST["Tid"] . "'";
                            $sentencia1 = "UPDATE bitllets SET id_viatge = NULL WHERE id_viatge = '" . $_POST["Tid"] . "'";
                            $sentencia2 = "DELETE FROM viatges WHERE id_viatge = '" . $_POST["Tid"] . "'";
                        ...
                        if (!$result2) {
                            ...
                            echo "<script>alert('Los datos del viaje se han eliminado correctamente correctamente.'); window.location.href = '../html/zap_gestionar.html';</script>";
